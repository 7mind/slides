...
\item We could leave implicits solely to implicit resolution, but that would've been \textit{unmodular},
...
\item Also, arbitrary functions can run from Locator when available
\end{enumerate}
\end{frame}
